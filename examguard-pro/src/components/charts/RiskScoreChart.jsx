...
export function RiskScoreChart({ sessionId }) {
  ...
  if (data.length === 0) data.push({ time: 'now', score: liveScore });
  else data.push({ time: 'live', score: liveScore });
